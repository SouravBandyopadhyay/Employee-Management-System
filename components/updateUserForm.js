...
export default function UpdateUserForm() {
  ...
  return (
    ...
    >
      ...
      <button className="flex justify-center text-md w-2/6 bg-yellow-500 text-white px-4 py-2 border rounded-md hover:bg-gray-50 border-green-500 hover:text-green-500">
        Update
        <span>
          <BiBrush size={24} />
        </span>
